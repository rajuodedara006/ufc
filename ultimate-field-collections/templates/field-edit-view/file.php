<?php
$displayed_fields = array( 'ID', 'key', 'required', 'label', 'name', 'instructions', 'parent', 'menu_order', '_name', '_valid', 'conditional_logic' );

$field_mime_types = (!empty($field_data['mime_types'])) ? $field_data['mime_types'] : '';

$field_width = (!empty($field_data['width'])) ? $field_data['width'] : '';
$field_height = (!empty($field_data['height'])) ? $field_data['height'] : '';
...
<div class="field-edit-view-wrap field-type-<?php esc_attr_e($field_type); ?>" data-acf_field_id="<?php esc_attr_e($field_ID); ?>">
  ...
  <div class="field-edit-content-main">
    ...
    <div class="field-edit-content-row">
      <div class="field-edit-col field-col-half">
        <?php $displayed_fields[] = 'width'; $displayed_fields[] = 'height'; ?>
        <label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][width]"><?php esc_html_e('Width', "ufcsupport" ); ?></label>
        <div class="field-postfix-text-group">
          <input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][width]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][width]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( $field_width ); ?>">
      ...
      <div class="field-edit-col field-col-half">
        ...
        <div class="field-postfix-text-group">
          <input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][height]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][height]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( $field_height ); ?>">
          <span class="field-postfix-text"><?php esc_html_e('px', "ufcsupport" ); ?></span>
        </div>
      </div>
    </div>
  ...
  <?php
	...
	?>
            <input type="hidden" name="acf_fields[<?php esc_attr_e($field_ID); ?>][<?php esc_attr_e($logic_group_no); ?>][<?php esc_attr_e($logic_no); ?>][field]" value="<?php esc_attr_e($logic_arr['field']); ?>">
            <input type="hidden" name="acf_fields[<?php esc_attr_e($field_ID); ?>][<?php esc_attr_e($logic_group_no); ?>][<?php esc_attr_e($logic_no); ?>][operator]" value="<?php esc_attr_e($logic_arr['operator']); ?>">
  <?php
					}
				}
			}
