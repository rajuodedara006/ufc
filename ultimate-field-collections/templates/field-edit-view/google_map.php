...
<div class="field-edit-view-wrap field-type-<?php esc_attr_e($field_type); ?>" data-acf_field_id="<?php esc_attr_e($field_ID); ?>">
	...
	<div class="field-edit-content-main">
		...
		<div class="field-edit-content-row">
			<?php $displayed_fields[] = 'center_lat';
			$displayed_fields[] = 'center_lng'; ?>
			<div class="field-edit-col field-col-half">
				<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][center_lat]"><?php esc_html_e('Center of Map', "ufcsupport" ); ?></label>
				<div class="field-prefix-text-group">
					<span class="field-prefix-text"><?php esc_html_e('Latitude', "ufcsupport" ); ?></span>
					<input type="text" name="acf_fields[<?php esc_attr_e($field_ID); ?>][center_lat]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][center_lat]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( (!empty($field_data['center_lat'])) ? $field_data['center_lat'] : '' ); ?>">
				</div>
			</div>
			<div class="field-edit-col field-col-half">
				<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][center_lng]"></label>
				<div class="field-prefix-text-group">
					<span class="field-prefix-text"><?php esc_html_e('Longitude', "ufcsupport" ); ?></span>
					<input type="text" name="acf_fields[<?php esc_attr_e($field_ID); ?>][center_lng]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][center_lng]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( (!empty($field_data['center_lng'])) ? $field_data['center_lng'] : ''); ?>">
				</div>
			</div>
		</div>
		<div class="field-edit-content-row">
			<?php $displayed_fields[] = 'zoom';
			$displayed_fields[] = 'height'; ?>
			<div class="field-edit-col field-col-half">
				<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][zoom]"><?php esc_html_e('Zoom Level', "ufcsupport" ); ?></label>
				<input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][zoom]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][zoom]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( (!empty($field_data['zoom'])) ? $field_data['zoom'] : ''); ?>">
			</div>
			<div class="field-edit-col field-col-half">
				<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][height]"><?php esc_html_e('Height', "ufcsupport" ); ?></label>
				<input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][height]" name="acf_fields[<?php esc_attr_e($field_ID); ?>][height]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( (!empty($field_data['height'])) ? $field_data['height'] : ''); ?>">
			</div>
		</div>
	</div>
