	...
	<div class="field-edit-content-main">
		...
		<div class="field-edit-content-row">
			...
			<div class="field-edit-col">
				...
				<input type="hidden" id="acf_fields-<?php esc_attr_e($field_ID); ?>-post_type-input" name="acf_fields[<?php esc_attr_e($field_ID); ?>][post_type]">
					...
					if ( !empty($post_types) ) {
						foreach ($post_types as $post_type_data) {
							if ( !empty($post_type_data->label) ) {
								$selected = ($field_data['post_type']==$post_type_data->name) ? 'selected' : '' ;
		...
		<div class="field-edit-content-row">
			...
			<div class="field-edit-col">
				<label class="field-label" for="acf_fields-<?php esc_attr_e($field_ID); ?>-taxonomy-input"><?php esc_html_e('Filter by Taxonomy', "ufcsupport" ); ?></label>
				<input type="hidden" id="acf_fields-<?php esc_attr_e($field_ID); ?>-taxonomy-input" name="acf_fields[<?php esc_attr_e($field_ID); ?>][taxonomy]">
							...
							if ( !empty($taxonomy_data->label) ) {
								...
								if ( !empty($taxonomy_terms) ) {									
									...
									foreach ($taxonomy_terms as $term_data) {
										...
										$selected = ($field_data['taxonomy']==$taxonomy_data->name.':'.$term_data->slug) ? 'selected' : '' ;
