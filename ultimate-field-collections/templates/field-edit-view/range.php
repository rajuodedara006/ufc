<?php $displayed_fields = array( 'ID', 'type', 'key', 'default_value', 'step', 'min', 'max', 'required', 'label', 'name', 'instructions', 'parent', 'menu_order', '_name', '_valid', 'conditional_logic' ); ?>
<div class="field-edit-view-wrap field-type-<?php esc_attr_e($field_type); ?>"
    ...
    <div class="field-edit-content-main">
        ...
        <div class="field-edit-content-row">
            <div class="field-edit-col field-col-half">
                <label class="field-label"
                    for="acf_fields[<?php esc_attr_e($field_ID); ?>][default_value]"><?php esc_html_e('Default Value', "ufcsupport" ); ?></label>
                <input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][default_value]"
                    id="acf_fields[<?php esc_attr_e($field_ID); ?>][default_value]"
                    class="ufc-field-input ufc-field-enter-to-save"
                    value="<?php esc_attr_e( (!empty($field_data['default_value'])) ? $field_data['default_value'] : ''); ?>">
            </div>
            <div class="field-edit-col field-col-half">
                <label class="field-label"
                    for="acf_fields[<?php esc_attr_e($field_ID); ?>][step]"><?php esc_html_e('Step Size', "ufcsupport" ); ?></label>
                <input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][step]"
                    id="acf_fields[<?php esc_attr_e($field_ID); ?>][step]"
                    class="ufc-field-input ufc-field-enter-to-save"
                    value="<?php esc_attr_e( (!empty($field_data['step'])) ? $field_data['step'] : ''); ?>"
                    placeholder="1">
            </div>
        </div>
        ...
        <div class="field-edit-content-row">
            <div class="field-edit-col field-col-half">
                <label class="field-label"
                    for="acf_fields[<?php esc_attr_e($field_ID); ?>][min]"><?php esc_html_e('Minimum Value', "ufcsupport" ); ?></label>
                <input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][min]"
                    id="acf_fields[<?php esc_attr_e($field_ID); ?>][min]"
                    class="ufc-field-input ufc-field-enter-to-save"
                    value="<?php esc_attr_e( (!empty($field_data['min'])) ? $field_data['min'] : ''); ?>"
                    placeholder="0">
            </div>
            <div class="field-edit-col field-col-half">
                <label class="field-label"
                    for="acf_fields[<?php esc_attr_e($field_ID); ?>][max]"><?php esc_html_e('Maximum Value', "ufcsupport" ); ?></label>
                <input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][max]"
                    id="acf_fields[<?php esc_attr_e($field_ID); ?>][max]"
                    class="ufc-field-input ufc-field-enter-to-save"
                    value="<?php esc_attr_e( (!empty($field_data['max'])) ? $field_data['max'] : ''); ?>"
                    placeholder="100">
            </div>
        </div>
