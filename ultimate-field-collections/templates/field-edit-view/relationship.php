<?php $displayed_fields = array( 'ID', 'type', 'key', 'required', 'multiple', 'allow_null', 'post_type', 'label', 'name', 'instructions', 'parent', 'menu_order', '_name', '_valid', 'conditional_logic' ); ?>
<div class="field-edit-view-wrap field-type-<?php esc_attr_e($field_type); ?>" data-acf_field_id="<?php esc_attr_e($field_ID); ?>">
	...
	<div class="field-edit-content-main">
		...
		<div class="field-edit-content-row field_hide_allow_null_wrap">
			<div class="field-edit-col">
				<label class="ufc-field-checkbox-switch" for="acf_fields[<?php esc_attr_e($field_ID); ?>][allow_null]">
					<?php esc_html_e('Allow Null?', "ufcsupport" ); ?>
					<input type="checkbox" name="acf_fields[<?php esc_attr_e($field_ID); ?>][allow_null]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][allow_null]" class="ufc-field-checkbox" value="1" <?php echo (!empty($field_data['allow_null'])) ? 'checked' : ''; ?> >
					<span class="ufc-field-checkbox-slider">
						<span class="ufc-field-checkbox-yes"><?php esc_html_e('Yes', "ufcsupport" ); ?></span>
						<span class="ufc-field-checkbox-no"><?php esc_html_e('No', "ufcsupport" ); ?></span>
					</span>
		...
		<div class="field-edit-content-row">
			<div class="field-edit-col">
				<label class="ufc-field-checkbox-switch" for="acf_fields[<?php esc_attr_e($field_ID); ?>][multiple]">
					...
					<input type="checkbox" name="acf_fields[<?php esc_attr_e($field_ID); ?>][multiple]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][multiple]" class="ufc-field-checkbox" value="1" <?php echo (!empty($field_data['multiple'])) ? 'checked' : ''; ?> >
					<span class="ufc-field-checkbox-slider">
						<span class="ufc-field-checkbox-yes"><?php esc_html_e('Yes', "ufcsupport" ); ?></span>
						<span class="ufc-field-checkbox-no"><?php esc_html_e('No', "ufcsupport" ); ?></span>
					</span>
		...
		<div class="field-edit-content-row">
			...
			<div class="field-edit-col">
				<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][post_type][]"><?php esc_html_e('Filter by Post Type', "ufcsupport" ); ?></label>
				<input type="hidden" name="acf_fields[<?php esc_attr_e($field_ID); ?>][post_type]">
				<select class="ufc-field-select ufc-field-select2" name="acf_fields[<?php esc_attr_e($field_ID); ?>][post_type][]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][post_type][]" data-placeholder="All post types" multiple>
					<?php
		...
		<div class="field-edit-content-row">
			...
			<div class="field-edit-col">
				<label class="field-label" id="acf_fields[<?php esc_attr_e($field_ID); ?>][taxonomy][]"><?php esc_html_e('Filter by Taxonomy', "ufcsupport" ); ?></label>
				<input type="hidden" name="acf_fields[<?php esc_attr_e($field_ID); ?>][taxonomy]" id="acf_fields-<?php esc_attr_e($field_ID); ?>-taxonomy-input">
				<select class="ufc-field-select ufc-field-select2" name="acf_fields[<?php esc_attr_e($field_ID); ?>][taxonomy][]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][taxonomy][]" data-placeholder="All taxonomies" multiple>
					<?php
		...
		<div class="field-edit-content-row">
			<?php $displayed_fields[] = 'filters'; ?>
			<div class="field-edit-col">
				<label class="field-label"><?php esc_html_e('Filter by Post Type', "ufcsupport" ); ?></label>
				<input type="hidden" id="acf_fields-<?php esc_attr_e($field_ID); ?>-filters-input" name="acf_fields[<?php esc_attr_e($field_ID); ?>][filters]">
				<ul class="acf-checkbox-list acf-bl">
					<li><label><input type="checkbox" id="acf_fields-<?php esc_attr_e($field_ID); ?>-filters-search" name="acf_fields[<?php esc_attr_e($field_ID); ?>][filters][]" value="search" <?php echo (!empty($field_data['filters']) && (in_array("search", $field_data['filters']) ) ) ? 'checked="checked"' : '' ; ?> > <?php esc_html_e('Search', "ufcsupport" ); ?></label></li>
					<li><label><input type="checkbox" id="acf_fields-<?php esc_attr_e($field_ID); ?>-filters-post_type" name="acf_fields[<?php esc_attr_e($field_ID); ?>][filters][]" value="post_type" <?php esc_attr_e( (!empty($field_data['filters']) && (in_array("post_type", $field_data['filters']) ) ) ? 'checked="checked"' : '' ); ?> > <?php esc_html_e('Post Type', "ufcsupport" ); ?></label></li>
					<li><label class=""><input type="checkbox" id="acf_fields-<?php esc_attr_e($field_ID); ?>-filters-taxonomy" name="acf_fields[<?php esc_attr_e($field_ID); ?>][filters][]" value="taxonomy" <?php esc_attr_e( (!empty($field_data['filters']) && (in_array("taxonomy", $field_data['filters']) ) ) ? 'checked="checked"' : '' ); ?> > <?php esc_html_e('Taxonomy', "ufcsupport" ); ?></label></li>
				</ul>
			</div>
		</div>
