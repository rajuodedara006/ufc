		...
		<div class="field-edit-options-wrap">
			...
			<div class="field-edit-options-lists">
				<?php if ( !empty($field_data['choices']) ) {
					...
					<div class="field-edit-content-row">
						<div class="field-edit-col field-col-half">
							<input type="text" name="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_values][]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_values][]" class="ufc-field-input" value="">
						</div>
						<div class="field-edit-col field-col-half">
							<input type="text" name="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_keys][]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][choice_keys][]" class="ufc-field-input" value="">
							<span class="field-edit-remove-option"><i class="fa fa-trash-alt"></i></span>
						</div>
					</div>
				<?php } ?>
