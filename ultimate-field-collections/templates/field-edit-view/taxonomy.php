<?php $displayed_fields = array( 'ID', 'type', 'key', 'required', 'field_type', 'allow_null', 'add_term', 'save_terms', 'load_terms', 'label', 'name', 'instructions', 'parent', 'menu_order', '_name', '_valid', 'conditional_logic' ); ?>
<div class="field-edit-view-wrap field-type-<?php esc_attr_e($field_type); ?>" data-acf_field_id="<?php esc_attr_e($field_ID); ?>">
	...
	<div class="field-edit-content-main">
		...
		<div class="field-edit-content-row">
			...
			<div class="field-edit-col">
				<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][taxonomy]"><?php esc_html_e('Taxonomy', "ufcsupport" ); ?></label>
				<select class="ufc-field-select" name="acf_fields[<?php esc_attr_e($field_ID); ?>][taxonomy]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][taxonomy]">
					<?php
					$taxonomies = get_taxonomies( array(), 'objects' );
					if ( !empty($taxonomies) ) {
						foreach ($taxonomies as $taxonomy_key => $taxonomy_data) {
							if ( !empty($taxonomy_data->label) ) {
								$selected = ($field_data['taxonomy']==$taxonomy_data->name) ? 'selected' : '' ;
								echo '<option value="'.esc_attr($taxonomy_data->name).'" '.esc_attr($selected).'>'.esc_html__($taxonomy_data->label).'</option>';
							}
						}
					}
					?>
		...
		<div class="field-edit-content-row">
			<div class="field-edit-col">
				<label class="ufc-field-checkbox-switch" for="acf_fields[<?php esc_attr_e($field_ID); ?>][add_term]">
					<?php esc_html_e('Create Terms', "ufcsupport" ); ?>
					<input type="checkbox" name="acf_fields[<?php esc_attr_e($field_ID); ?>][add_term]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][add_term]" class="ufc-field-checkbox" value="1" <?php echo (!empty($field_data['add_term'])) ? 'checked' : ''; ?> >
					<span class="ufc-field-checkbox-slider">
						<span class="ufc-field-checkbox-yes"><?php esc_html_e('Yes', "ufcsupport" ); ?></span>
						<span class="ufc-field-checkbox-no"><?php esc_html_e('No', "ufcsupport" ); ?></span>
					</span>
		...
		<div class="field-edit-content-row">
			<div class="field-edit-col">
				<label class="ufc-field-checkbox-switch" for="acf_fields[<?php esc_attr_e($field_ID); ?>][save_terms]">
					<?php esc_html_e('Save Terms', "ufcsupport" ); ?>
					<input type="checkbox" name="acf_fields[<?php esc_attr_e($field_ID); ?>][save_terms]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][save_terms]" class="ufc-field-checkbox" value="1" <?php echo (!empty($field_data['save_terms'])) ? 'checked' : ''; ?> >
					<span class="ufc-field-checkbox-slider">
						<span class="ufc-field-checkbox-yes"><?php esc_html_e('Yes', "ufcsupport" ); ?></span>
						<span class="ufc-field-checkbox-no"><?php esc_html_e('No', "ufcsupport" ); ?></span>
					</span>
		...
		<div class="field-edit-content-row">
			<div class="field-edit-col">
				<label class="ufc-field-checkbox-switch" id="acf_fields[<?php esc_attr_e($field_ID); ?>][load_terms]">
					<?php esc_html_e('Load Terms', "ufcsupport" ); ?>
					<input type="checkbox" name="acf_fields[<?php esc_attr_e($field_ID); ?>][load_terms]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][load_terms]" class="ufc-field-checkbox" value="1" <?php echo (!empty($field_data['load_terms'])) ? 'checked' : ''; ?> >
					<span class="ufc-field-checkbox-slider">
						<span class="ufc-field-checkbox-yes"><?php esc_html_e('Yes', "ufcsupport" ); ?></span>
						<span class="ufc-field-checkbox-no"><?php esc_html_e('No', "ufcsupport" ); ?></span>
					</span>
