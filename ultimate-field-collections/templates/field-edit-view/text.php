...
<div class="field-edit-view-wrap field-type-<?php esc_attr_e($field_type); ?>" data-acf_field_id="<?php esc_attr_e($field_ID); ?>">
	...
	<div class="field-edit-content-main">
		...
		<?php
		if ( in_array( $field_type, array('date_picker', 'date_time_picker', 'time_picker') ) ) { ?>
			<div class="field-edit-content-row">
				<?php
				$displayed_fields[] = 'time_picker';
				$displayed_fields[] = 'display_format';
				$displayed_fields[] = 'return_format';

				if ( $field_type == 'date_time_picker' ) {
					$display_format = 'd/m/Y g:i a';
					$return_format = 'd/m/Y g:i a';
				} else if ( $field_type == 'time_picker' ) {
				...
				echo '<input type="hidden" class="date_time_picker-display_format" name="acf_fields['.esc_attr($field_ID).'][display_format]" value="'.esc_attr( $display_format ).'">';

				echo '<input type="hidden" class="date_time_picker-return_format" name="acf_fields['.esc_attr($field_ID).'][return_format]" value="'.esc_attr( $return_format ).'">';
				?>
				<div class="field-edit-col">
					<label class="ufc-field-checkbox-switch" for="acf_fields[<?php esc_attr_e($field_ID); ?>][time_picker]">
						<?php esc_html_e('Display Time?', "ufcsupport" ); ?>
						<input type="checkbox" name="acf_fields[<?php esc_attr_e($field_ID); ?>][time_picker]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][time_picker]" class="ufc-field-checkbox ufc_date_time_picker_checkbox" value="1" <?php echo ( in_array( $field_type, array('date_time_picker', 'time_picker') ) ) ? 'checked' : ''; ?> data-field_type_off='date_picker' data-field_type_on='date_time_picker'>
						<span class="ufc-field-checkbox-slider">
							<span class="ufc-field-checkbox-yes"><?php esc_html_e('Yes', "ufcsupport" ); ?></span>
							<span class="ufc-field-checkbox-no"><?php esc_html_e('No', "ufcsupport" ); ?></span>
						</span>
			...
			<div class="field-edit-content-row">
				<?php $displayed_fields[] = 'date_picker'; ?>
				<div class="field-edit-col">
					<label class="ufc-field-checkbox-switch" for="acf_fields[<?php esc_attr_e($field_ID); ?>][date_picker]">
						<?php esc_html_e('Display Date?', "ufcsupport" ); ?>
						<input type="checkbox" name="acf_fields[<?php esc_attr_e($field_ID); ?>][date_picker]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][date_picker]" class="ufc-field-checkbox ufc_date_picker_checkbox" value="1" <?php echo ( in_array( $field_type, array('date_picker', 'date_time_picker') ) ) ? 'checked' : ''; ?> data-field_type_off='date_picker' data-field_type_on='date_time_picker'>
						<span class="ufc-field-checkbox-slider">
							<span class="ufc-field-checkbox-yes"><?php esc_html_e('Yes', "ufcsupport" ); ?></span>
							<span class="ufc-field-checkbox-no"><?php esc_html_e('No', "ufcsupport" ); ?></span>
						</span>
		...
		<?php if ( in_array( $field_type, array('text') ) ) {
			$displayed_fields[] = 'minlength';
			$displayed_fields[] = 'maxlength'; ?>
			<div class="field-edit-content-row">
				<div class="field-edit-col field-col-half">
					<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][minlength]"><?php esc_html_e('Min. Character', "ufcsupport" ); ?></label>
					<input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][minlength]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][minlength]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e($field_minlength); ?>">
				</div>
				<div class="field-edit-col field-col-half">
					<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][maxlength]"><?php esc_html_e('Max. Character', "ufcsupport" ); ?></label>
					<input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][maxlength]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][maxlength]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e($field_maxlength); ?>">
				</div>
			</div>
		<?php } else if ( $field_type == 'number' ) {
			$displayed_fields[] = 'min';
			$displayed_fields[] = 'max'; ?>
			<div class="field-edit-content-row">
				<div class="field-edit-col field-col-half">
					<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][min]"><?php esc_html_e('Min. Number', "ufcsupport" ); ?></label>
					<input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][min]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][min]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( (!empty($field_data['min'])) ? $field_data['min'] : ''); ?>">
				</div>
				<div class="field-edit-col field-col-half">
					<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][max]"><?php esc_html_e('Max. Number', "ufcsupport" ); ?></label>
					<input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][max]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][max]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( (!empty($field_data['max'])) ? $field_data['max'] : ''); ?>">
				</div>
			</div>
		<?php } else if ( $field_type == 'true_false' ) {
			$displayed_fields[] = 'ui_on_text';
			$displayed_fields[] = 'ui_off_text'; ?>
			<div class="field-edit-content-row">
				<div class="field-edit-col field-col-half">
					<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][ui_on_text]"><?php esc_html_e('On Text', "ufcsupport" ); ?></label>
					<input type="text" name="acf_fields[<?php esc_attr_e($field_ID); ?>][ui_on_text]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][ui_on_text]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( (!empty($field_data['ui_on_text'])) ? $field_data['ui_on_text'] : ''); ?>">
				</div>
				<div class="field-edit-col field-col-half">
					<label class="field-label" for="acf_fields[<?php esc_attr_e($field_ID); ?>][ui_off_text]"><?php esc_html_e('Off Text', "ufcsupport" ); ?></label>
					<input type="text" name="acf_fields[<?php esc_attr_e($field_ID); ?>][ui_off_text]" id="acf_fields[<?php esc_attr_e($field_ID); ?>][ui_off_text]" class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e( (!empty($field_data['ui_off_text'])) ? $field_data['ui_off_text'] : ''); ?>">
				</div>
			</div>
		<?php } ?>
	</div>
