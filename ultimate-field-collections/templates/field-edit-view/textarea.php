...
<div class="field-edit-view-wrap field-type-<?php esc_attr_e($field_type); ?>"
    ...
    <div class="field-edit-content-main">
        ...
        <div class="field-edit-content-row">
            ...
            <div class="field-edit-col field-col-half">
                <label class="field-label"
                    for="acf_fields[<?php esc_attr_e($field_ID); ?>][minlength]"><?php esc_html_e('Min. Character', "ufcsupport" ); ?></label>
                <input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][minlength]"
                    id="acf_fields[<?php esc_attr_e($field_ID); ?>][minlength]"
                    class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e($field_minlength); ?>">
            </div>
            <div class="field-edit-col field-col-half">
                <label class="field-label"
                    for="acf_fields[<?php esc_attr_e($field_ID); ?>][maxlength]"><?php esc_html_e('Max. Character', "ufcsupport" ); ?></label>
                <input type="number" name="acf_fields[<?php esc_attr_e($field_ID); ?>][maxlength]"
                    id="acf_fields[<?php esc_attr_e($field_ID); ?>][maxlength]"
                    class="ufc-field-input ufc-field-enter-to-save" value="<?php esc_attr_e($field_maxlength); ?>">
            </div>
        </div>
    </div>
