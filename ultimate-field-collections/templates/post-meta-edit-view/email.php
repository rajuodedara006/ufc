...
<div id="<?php esc_attr_e($wrapper_id); ?>" class="<?php esc_attr_e($wrapper_class); ?>"
    ...
    <div class="acf-input">
        <div class="acf-input-wrap">
            <input type="email" id="<?php esc_attr_e('post-'.$ufc_field_post_id.'-acf-'.$field_key); ?>"
    ...
    <div class="ufc-field-errors">
        ...
        <p class="ufc-field-error-required"><?php esc_html_e("Please enter correct email address.", "ufcsupport" ); ?>
        </p>
    </div>
</div>