...
$wrapper_class = 'acf-field acf-field-'.$field_type.' ufc-group-default-view-wrapper acf-'.$field_key;
...
<div id="<?php esc_attr_e($wrapper_id); ?>" class="<?php esc_attr_e($wrapper_class); ?>" <?php esc_attr_e( implode(' ', $wrapper_attrs) ); ?> >
	<div class="acf-label">
		<?php if ( isset( $field_data['add_tab_sub_groups'] ) || isset( $field_data['add_accordion_sub_groups'] ) ) {} else { ?>
		...
		<div class="acf-input-wrap">
			...
			<div class="ufc-group-table">
				<div class="ufc-group-list-body">
					...
					$field_child_row++;
					?>
					<div class="acf-row" data-id="row-<?php esc_attr_e($field_child_row); ?>">
						<div class="acf-fields">
							<div class="ufc-group-sub-fields-main">
								<div class="ufc-group-sub-fields-wrap">
									<?php
									...
									if ( !empty($field_parent_data['sub_fields']) ) {
										foreach ($field_parent_data['sub_fields'] as $key => $field_data) {
											...
											if ( $field_type == 'group' && !isset( $field_data['group_accordion_field_open']) && !isset( $field_data['group_tab_field_open']) ) {
