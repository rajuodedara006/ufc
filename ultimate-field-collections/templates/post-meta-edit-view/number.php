...
<div id="<?php esc_attr_e($wrapper_id); ?>" class="<?php esc_attr_e($wrapper_class); ?>" <?php esc_attr_e( implode(' ', $wrapper_attrs) ); ?> >
	...
	<div class="acf-input">
		<div class="acf-input-wrap">
			<input type="number" id="<?php esc_attr_e('post-'.$ufc_field_post_id.'-acf-'.$field_key); ?>" name="acf[<?php esc_attr_e($field_key); ?>]" value="<?php esc_attr_e($field_value); ?>" <?php esc_attr_e( implode(' ', $input_attrs) ); ?> >
		</div>
	</div>
	<div class="ufc-field-errors">
		<p class="ufc-field-error-required"><?php esc_html_e("This field is required.", "ufcsupport" ); ?></p>
		<p class="ufc-field-error-minlength"><?php esc_html_e( sprintf("This field needs minimum value is %s.", $field_data['min'] ), "ufcsupport" ); ?></p>
		<p class="ufc-field-error-maxlength"><?php esc_html_e( sprintf("This field limits maximum value is %s.", $field_data['max'] ), "ufcsupport" ); ?></p>
	</div>
</div>