...
<div id="<?php esc_attr_e($wrapper_id); ?>" class="<?php esc_attr_e($wrapper_class); ?>"
    ...
    <div class="acf-input">
        <div class="acf-input-wrap">
            <textarea id="<?php esc_attr_e('post-'.$ufc_field_post_id.'-acf-'.$field_key); ?>"
                name="acf[<?php esc_attr_e($field_key); ?>]"
                <?php esc_attr_e( implode(' ', $input_attrs) ); ?>><?php esc_html_e( $field_value ); ?></textarea>
        </div>
    </div>
    <div class="ufc-field-errors">
        ...
        <p class="ufc-field-error-minlength">
            <?php esc_html_e( sprintf("This field needs minimum %s characters.", $field_data['minlength'] ), "ufcsupport" ); ?>
        </p>
        <p class="ufc-field-error-maxlength">
            <?php esc_html_e( sprintf("This field limits maximum %s characters.", $field_data['maxlength'] ), "ufcsupport" ); ?>
        </p>
    </div>
</div>