...
$ui_on_text = (!empty($field_data['ui_on_text'])) ? $field_data['ui_on_text'] : 'On';
$ui_off_text = (!empty($field_data['ui_off_text'])) ? $field_data['ui_off_text'] : 'Off';
	...
	<div class="acf-input">
		<div class="acf-input-wrap">
			<label class="ufc-field-checkbox-switch">
				<input type="checkbox" id="<?php esc_attr_e('post-'.$ufc_field_post_id.'-acf-'.$field_key); ?>" name="acf[<?php esc_attr_e($field_key); ?>]" value="1" <?php esc_attr_e( implode(' ', $input_attrs) ); ?> >
				<span class="ufc-field-checkbox-slider">
					<span class="ufc-field-checkbox-yes"><?php esc_html_e( $ui_on_text ); ?></span>
					<span class="ufc-field-checkbox-no"><?php esc_html_e( $ui_off_text ); ?></span>
				</span>
			</label>
